      ...
      <section className="py-20 px-6 md:px-12 bg-surface scroll-reveal">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {stats.map((stat) => (
              <div key={stat.label} className="glass-card p-8 rounded-2xl text-center group hover:shadow-[0_12px_40px_rgba(0,255,136,0.10)] hover:border-[#00ff88]/20 transition-all duration-500 stagger-item">
                <div className="text-[clamp(32px,4vw,48px)] font-extrabold text-[#00391c] mb-2">{stat.value}</div>
      ...
      <section className="py-20 px-6 md:px-12 bg-surface-container-low/20 scroll-reveal">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block text-xs font-bold text-[#00ff88] tracking-[0.2em] uppercase mb-3">Our Story</span>
      ...
      <section className="py-20 px-6 md:px-12 bg-surface scroll-reveal">
        <div className="max-w-[1440px] mx-auto">
          <div className="text-center mb-14">
            <span className="inline-block text-xs font-bold text-[#00ff88] tracking-[0.2em] uppercase mb-3">Team</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member) => (
              <div key={member.name} className="glass-card p-6 md:p-8 rounded-2xl text-center group transition-all duration-500 hover:shadow-[0_20px_60px_rgba(0,255,136,0.10)] hover:border-[#00ff88]/25 hover:-translate-y-1 stagger-item">
                <div className="w-24 h-24 rounded-full mx-auto mb-5 overflow-hidden ring-2 ring-[#00ff88]/20 group-hover:ring-[#00ff88]/40 transition-all duration-300">
          ...
          <div className="glass-card rounded-[2.5rem] overflow-hidden border border-[#00ff88]/15 relative shadow-[0_20px_80px_rgba(0,0,0,0.06)]">
            ...
            <div className="relative z-20 flex flex-col md:flex-row items-center justify-between p-10 md:p-16">
              <div className="max-w-xl text-center md:text-left">
                ...
                <Link to="/about" className="inline-flex items-center gap-2 bg-[#00ff88] text-[#00391c] font-bold text-base px-8 py-3.5 rounded-full shadow-[0_0_30px_rgba(0,255,136,0.3)] hover:shadow-[0_0_50px_rgba(0,255,136,0.5)] hover:scale-105 active:scale-95 transition-all duration-300">
                  Find a Shop
