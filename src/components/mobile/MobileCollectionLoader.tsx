...
import { ShoppingBag, Zap, ShieldCheck, Truck, Star } from 'lucide-react'

const messages = [
  { text: 'Loading products...', sub: 'Just a second' },
  { text: 'Finding best deals...', sub: 'Scanning prices for you' },
...
export default function MobileCollectionLoader() {
  ...
  return (
    <div className="flex flex-col items-center py-10 px-5">
      ...
      <style>{`
        .cloader-pulse-1 { animation: cpulse 2s ease-out infinite; }
        .cloader-pulse-2 { animation: cpulse 2s ease-out 0.7s infinite; }
        @keyframes cpulse {
