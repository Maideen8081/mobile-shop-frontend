          ...
          return (
            ...
            >
              <div
                ...
                style={active
                  ? { background: 'linear-gradient(135deg,#6C3BFF,#4B2ECC)', boxShadow: '0 10px 24px rgba(108,59,255,0.40)' }
              ...
              <span className={`text-[11px] text-center leading-tight max-w-[76px] truncate font-semibold ${active ? 'text-[#6C3BFF]' : 'text-[#1F2937]'}`}>
                {cat.name}
              </span>
            </Link>
          )
